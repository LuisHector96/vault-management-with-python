...
def func_create_external_group(client, **kwargs):
    ...
    try:
        ...
        create_response = client.secrets.identity.create_or_update_group_by_name(
            name=kwargs.get(
                "ext_grp_name"
            ),  # 'oidc_npe_APM0000000_adm' 'okt_npe_APM0000000_adm' 'aad_npe_APM0000000_adm'
            group_type="external",
            policies=kwargs.get("ext_policies"),
            metadata=dict(
                csdm="{ "
                + f"L1 = {kwargs.get('L1_APMID')}, L2 = {kwargs.get('L2_APMID')}"
                + " }",
...
def func_external_groups(client, **kwargs):
    ...
    # ADMIN
    oidc_ext_group = (
        f"oidc_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_adm".lower()
    )
    okt_ext_group = (
        f"okt_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_adm".lower()
    )
    aad_ext_group = (
        f"aad_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_adm".lower()
    )
    return_data[
        "ext_alias_group_adm"
    ] = f"{kwargs.get('prefix')}_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_adm".lower()
    accessors = kwargs.get("accessors")

    adm_ext_grp_id = dict()
    d_values = {
        "ext_grp_name": oidc_ext_group,
        "ext_policies": kwargs.get("ext_policies"),
        "L1_APMID": kwargs.get("l1_asset"),
        "L2_APMID": kwargs.get("L2_APMID"),
        "role": "adm",
        "message": "Admin oidc external group added!",
        "alias_name": return_data.get("ext_alias_group_adm"),
        "accessor": accessors["oidc/"]["accessor"],
    }
    adm_ext_grp_id["oidc"] = func_create_external_group(client, **d_values)

    d_values = {
        "ext_grp_name": okt_ext_group,
        "ext_policies": kwargs.get("ext_policies"),
        "L1_APMID": kwargs.get("l1_asset"),
        "L2_APMID": kwargs.get("L2_APMID"),
        "role": "adm",
        "message": "Admin okt external group added!",
        "alias_name": return_data.get("ext_alias_group_adm"),
        "accessor": accessors["okt/"]["accessor"],
    }
    adm_ext_grp_id["okt"] = func_create_external_group(client, **d_values)

    d_values = {
        "ext_grp_name": aad_ext_group,
        "ext_policies": kwargs.get("ext_policies"),
        "L1_APMID": kwargs.get("l1_asset"),
        "L2_APMID": kwargs.get("L2_APMID"),
        "role": "adm",
        "message": "Admin aad external group added!",
        "alias_name": return_data.get("ext_alias_group_adm"),
        "accessor": accessors["aad/"]["accessor"],
    }
    ...
    # READ/WRITE
    oidc_ext_group = (
        f"oidc_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_rw".lower()
    )
    okt_ext_group = (
        f"okt_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_rw".lower()
    )
    aad_ext_group = (
        f"aad_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_rw".lower()
    )
    return_data[
        "ext_alias_group_rw"
    ] = f"{kwargs.get('prefix')}_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_rw".lower()
    accessors = kwargs.get("accessors")
    ...
    d_values = {
        ...
        "L2_APMID": kwargs.get("L2_APMID"),
        "role": "rw",
        "message": "Read/Write oidc external group added!",
        "alias_name": return_data.get("ext_alias_group_rw"),
        "accessor": accessors["oidc/"]["accessor"],
    }
    ...
    d_values = {
        ...
        "L2_APMID": kwargs.get("L2_APMID"),
        "role": "rw",
        "message": "Read/Write okt external group added!",
        "alias_name": return_data.get("ext_alias_group_rw"),
        "accessor": accessors["okt/"]["accessor"],
    }
    ...
    d_values = {
        ...
        "L2_APMID": kwargs.get("L2_APMID"),
        "role": "rw",
        "message": "Read/Write aad external group added!",
        "alias_name": return_data.get("ext_alias_group_rw"),
        "accessor": accessors["aad/"]["accessor"],
    }
    ...
    # READ ONLY
    oidc_ext_group = (
        f"oidc_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_ro".lower()
    )
    okt_ext_group = (
        f"okt_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_ro".lower()
    )
    aad_ext_group = (
        f"aad_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_ro".lower()
    )
    return_data[
        "ext_alias_group_ro"
    ] = f"{kwargs.get('prefix')}_{kwargs.get('environment')}_{kwargs.get('L2_APMID')}_ro".lower()
    accessors = kwargs.get("accessors")
    ...
    d_values = {
        ...
        "L2_APMID": kwargs.get("L2_APMID"),
        "role": "ro",
        "message": "Read Only oidc external group added!",
        "alias_name": return_data.get("ext_alias_group_ro"),
        "accessor": accessors["oidc/"]["accessor"],
    }
    ...
    d_values = {
        ...
        "L2_APMID": kwargs.get("L2_APMID"),
        "role": "ro",
        "message": "Read Only okt external group added!",
        "alias_name": return_data.get("ext_alias_group_ro"),
        "accessor": accessors["okt/"]["accessor"],
    }
    ...
    d_values = {
        ...
        "L2_APMID": kwargs.get("L2_APMID"),
        "role": "ro",
        "message": "Read Only aad external group added!",
        "alias_name": return_data.get("ext_alias_group_ro"),
        "accessor": accessors["aad/"]["accessor"],
    }
