...
url_l2_owner = (
    "https://core.saas.api.t-mobile.com/api/asset-portfolio/v2/employee-details?ntid"
)
# url for canvas api L2 asset
url_l2_asset = (
    "https://core.saas.api.t-mobile.com/api/asset-portfolio/v2/business-application"
)
...
# snow api endpoint
url_snow = "https://tmobilea-sb02.apigee.net/api/asset-portfolio/v1/asset-ad-group/<CSDM ID>?environment=<env>"
...
EMAIL_RESEND = True if (os.environ["EMAIL_RESEND"].title() == "True") else False
TEST_JOB = True if (os.environ["TEST_JOB"].title() == "True") else False
